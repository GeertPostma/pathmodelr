#' Gets the indices of the previous nodes in a connection matrix given a node_index
#'
#' Gets the integer indices of the previous nodes given a connection_matrix and a
#' starting index.
#'
...
#'   determined.
#' @return A list of indices of all previous level nodes
get_previous_node_indices <- function(connection_matrix, node_index){
